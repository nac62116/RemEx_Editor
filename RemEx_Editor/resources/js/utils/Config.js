...
const Config = {
    ...
    ACCEPTED_RESOURCE_MIME_TYPES: ["video/webm", "video/3gpp", "video/mp4", "image/jpeg", "image/png", "image/bmp", "image/gif"],
    ...
    FILE_TYPE_NOT_SUPPORTED: "Der Dateityp wird nicht unterstützt. Unterstützte Videoformate sind: .mp4, .webm, .3gp. Unterstützte Bildformate sind: .jpg, .jpeg, .jpe, .png, .bmp, .gif.",
